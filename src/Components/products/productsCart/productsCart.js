...
const ProductsCart = ({ product }) => {
  ...
  return (
    <div className=" lg:pt-[50px] lg:pb-[50px] max-lg:pt-[60px] max-lg:pb-[60px]">
      <div className="grid grid-cols-12 max-[500px]:grid-cols-1 xl:gap-2 lg:gap-5 md:gap-8 sm:gap-4 max-2xl:gap-8">
        {product &&
          product.map((product) => {
            ...
            return (
              <div
                key={product._id}
                className="xl:col-span-3 h-[380px] bg-[#fff] border-1 border-[#fffdfd00] shadow-cart_shadow cursor-pointer max-xl:col-span-4 max-lg:col-span-6"
              >
                <Link
