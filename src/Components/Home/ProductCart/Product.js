...
const Product = ({ product }) => {
  ...
  return (
    <div className=" lg:pt-[50px] lg:pb-[50px] max-lg:pt-[60px] max-lg:pb-[60px]">
      <div className=" text-center font-Roboto font-black uppercase text-[35px] border-b-2 border-[#ffffff96] lg:w-[20%] md:w-[30%] sm:w-[40%] m-auto max-2xl:w-[50%]">
        <h3>Product</h3>
      </div>
      <div className="grid grid-cols-12 xl:gap-2 lg:gap-5 md:gap-8 sm:gap-4 max-2xl:gap-8 sm:mt-[60px] max-2xl:mt-[50px]">
        {product &&
          product.map((product) => {
            ...
            return (
              <div
                key={product._id}
                className="xl:col-span-2 lg:col-span-3 sm:col-span-4 h-[380px] bg-[#fff] border-1 border-[#fffdfd00] shadow-cart_shadow cursor-pointer max-2xl:col-span-6"
              >
                <Link
                ...
                >
                  <div className="h-[220px] xl:pt-4">
                    <img
                      className="h-[200px] inline-block xl:w-[100%] max-xl:w-[70%] max-xl:m-[auto] max-xl:flex max-xl:pt-[5px]"
                      src={photoUrl}
                      alt={product.name}
                    />
                  </div>
